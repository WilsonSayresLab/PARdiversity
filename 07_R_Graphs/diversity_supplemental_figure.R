...
for (i in 1:5) {
  ...
  filtered_pi.All26.100kb_filtered.o <- read.delim("~/Projects/PAR/BrotmanCotter/PAR_Project/Codes_04/05_pi/03_pi/filtered_pi/overlapping/100kb_filtered/filtered_pi.All26.100kb_filtered.o.txt", header=FALSE)
  ...
  filtered_100kb_All26.o.panTro4 <- read.delim("~/Projects/PAR/BrotmanCotter/PAR_Project/Codes_04/05_pi/04_normalized_pi/normalized_filtered_pi/overlapping/100kb_filtered/All26.100kb_filtered.o.panTro4.txt", header=FALSE)
  ...
  filtered_100kb_All26.o.RheMac3 <- read.delim("~/Projects/PAR/BrotmanCotter/PAR_Project/Codes_04/05_pi/04_normalized_pi/normalized_filtered_pi/overlapping/100kb_filtered/All26.100kb_filtered.o.RheMac3.txt", header=FALSE)
  ...
  filtered_100kb_All26.o.canFam3 <- read.delim("~/Projects/PAR/BrotmanCotter/PAR_Project/Codes_04/05_pi/04_normalized_pi/normalized_filtered_pi/overlapping/100kb_filtered/All26.100kb_filtered.o.canFam3.txt", header=FALSE)
  ...
  filtered_100kb_All26.o.mm10 <- read.delim("~/Projects/PAR/BrotmanCotter/PAR_Project/Codes_04/05_pi/04_normalized_pi/normalized_filtered_pi/overlapping/100kb_filtered/All26.100kb_filtered.o.mm10.txt", header=FALSE)
