...
#this program will make temp files of sorted filtered CGS data for all 26 females based on 1 Mb overlapping windows and position along the X chromosome
#---------------------------------------------------------------------------------
my $count = 0;
