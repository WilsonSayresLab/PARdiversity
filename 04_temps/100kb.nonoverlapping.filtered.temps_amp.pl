...
my $cg_input = "/Users/wilsonsayres_lab_admin/Projects/PAR/BrotmanCotter/PAR_Project/Codes_04/01_CompleteGenomics/All26.females/Output_Files/filtered.CGS.All26_amp.txt";
...
foreach (<$INTERVAL>){
    chomp;
    my( $start, $end ) = split /\t/;
    open my $OUT, ">", $output_directory."temp_file_".$count++."_amp.txt";    
