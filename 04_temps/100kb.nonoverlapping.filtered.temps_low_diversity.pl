...
#this program will make temp files of sorted filtered CGS data for all 26 females based on 100 kb non overlapping windows and position along the X chromosome
#---------------------------------------------------------------------------------
my $count = 0;
...
my $cg_input = "/Users/wilsonsayres_lab_admin/Projects/PAR/BrotmanCotter/PAR_Project/Codes_04/01_CompleteGenomics/All26.females/Output_Files/filtered.CGS.All26_low_diversity.txt";
...
foreach (<$INTERVAL>){
    chomp;
    my( $start, $end ) = split /\t/;
    open my $OUT, ">", $output_directory."temp_file_".$count++."_low_diversity.txt";    
