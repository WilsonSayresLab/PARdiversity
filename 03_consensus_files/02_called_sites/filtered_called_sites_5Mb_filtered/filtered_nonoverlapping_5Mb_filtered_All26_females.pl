...
my $usage = "filtered_non_overlapping_5Mb_all26_females.pl\n"; 
...
my $output_directory = "/Users/wilsonsayres_lab_admin/Projects/PAR/BrotmanCotter/PAR_Project/Codes_04/03_consensus_files/02_called_sites/filtered_called_sites_5Mb_filtered/";	

my $output_file = "$output_directory" . "filtered_nonoverlapping_5Mb_filtered_"."$population".".txt";
...
while($chr < 24) {
	...
	my $intervals = "/Users/wilsonsayres_lab_admin/Projects/PAR/BrotmanCotter/PAR_Project/Codes_04/02_galaxy_chrX_data/chrX_5Mbwindow_nonoverlapping.txt";
