...
my $usage = "unfiltered_26_females.pl"; 
#-------------------------------------------------------------------------------
...
my $output_file = "/Users/wilsonsayres_lab_admin/Projects/PAR/BrotmanCotter/PAR_Project/Codes_04/03_consensus_files/02_called_sites/called_sites_by_region/All26_females.txt";
...
my $input_file = "$input_dir"."mask."."$population".".chr.23".".txt";
...
my $CGS_nonPAR = substr( $cgs, 2699001, 152241558 );  

print OUT "nonPAR length= ".length $CGS_nonPAR;
