...
my $output_file = "/Users/wilsonsayres_lab_admin/Projects/PAR/BrotmanCotter/PAR_Project/Codes_04/03_consensus_files/02_called_sites/filtered_called_sites_by_region/All26_females_minus_low.txt";
...
my $input_file = "$input_dir"."filtered."."mask."."$population".".chr.23"."_minus_low.txt";
...
my $CGS_nonPAR_minus_low = substr( $cgs, 2699001, 152241558 );  

print OUT "nonPAR_minus_low length= ".length $CGS_nonPAR_minus_low;
 
printf OUT " found %d zeros\n", $CGS_nonPAR_minus_low =~ tr[0][];
