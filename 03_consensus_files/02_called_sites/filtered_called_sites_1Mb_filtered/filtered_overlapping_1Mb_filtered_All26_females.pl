...
my $usage = "filtered_overlapping_1Mb_all26_females.pl\n"; 
...
my $output_directory = "/Users/wilsonsayres_lab_admin/Projects/PAR/BrotmanCotter/PAR_Project/Codes_04/03_consensus_files/02_called_sites/filtered_called_sites_1Mb_filtered/";	

my $output_file = "$output_directory" . "filtered_overlapping_1Mb_filtered_"."$population".".txt";
