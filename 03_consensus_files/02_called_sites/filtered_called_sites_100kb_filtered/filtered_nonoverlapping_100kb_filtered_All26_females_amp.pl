...
my $output_file = "$output_directory" . "filtered_nonoverlapping_100kb_filtered_"."$population"."_amp.txt";
...
while($chr < 24) {
	...
	my $input_file = "$input_dir"."filtered.mask."."$population".".chr."."$chr"."_amp.txt";
