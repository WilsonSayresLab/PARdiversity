...
my $usage = "filtered_non_overlapping_100kb_all26_females.pl\n"; 
...
my $output_directory = "/Users/wilsonsayres_lab_admin/Projects/PAR/BrotmanCotter/PAR_Project/Codes_04/03_consensus_files/02_called_sites/filtered_called_sites_100kb_filtered/";

my $output_file = "$output_directory" . "filtered_nonoverlapping_100kb_filtered_"."$population"."_low_diversity.txt";
...
while($chr < 24) {
	...
	my $input_file = "$input_dir"."filtered.mask."."$population".".chr."."$chr"."_low_diversity.txt";
