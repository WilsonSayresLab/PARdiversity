...
open( OUT, ">/Users/wilsonsayres_lab_admin/Projects/PAR/BrotmanCotter/PAR_Project/Codes_04/03_consensus_files/01_mask_files/filtered_mask_files/filtered.mask."."$population".".chr.23.txt") or die "can't open output file\n";

my $mask_input = <INPUT>;
close INPUT;

my $filtered_sites = "/Users/wilsonsayres_lab_admin/Projects/PAR/BrotmanCotter/PAR_Project/Codes_04/02_galaxy_chrX_data/filtered_chrX_interval.txt";
