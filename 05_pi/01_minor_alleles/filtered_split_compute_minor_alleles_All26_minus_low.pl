...
my $CGS_nonPAR_input = "/Users/wilsonsayres_lab_admin/Projects/PAR/BrotmanCotter/PAR_Project/Codes_04/01_CompleteGenomics/All26.females/Output_Files/split.CGS.All26.nonPAR_minus_low.txt";
...
my $output_file_nonPAR = "$output_dir"."$population"."_nonPAR_minor_alleles_minus_low.txt";
