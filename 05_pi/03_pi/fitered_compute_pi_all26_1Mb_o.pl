...
#-------------------------------------------------------------------------------
# What: This program will compute pi for all 26 females from frequency tables generated with 1 Mb overlapping windows.
#-------------------------------------------------------------------------------

my $usage = "fitered_compute_pi_all26_1Mb_o.pl";
