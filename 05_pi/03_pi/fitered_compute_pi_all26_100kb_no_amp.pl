...
my $input_2 = "$input_directory_2"."filtered_"."$window_type"."_"."$window_size"."_"."$pop"."_females_amp.txt";
...
my $output_file = "$output_dir"."filtered_pi."."$pop."."$window_size."."$consensus_type"."_amp.txt";
...
while($count < $count_number){
	...
	if ($neutral_sites > 0) {
		...
		my $input_file = "$input_dir"."filtered_$pop"."_p_sites."."$count"."_amp.txt";
