...
#-------------------------------------------------------------------------------
# What: This program will compute pi for all 26 females from frequency tables generated with 100kb overlapping windows.
#-------------------------------------------------------------------------------

my $usage = "fitered_compute_pi_all26_100kb_o.pl";
...
#my $window_type = "non_overlapping";
