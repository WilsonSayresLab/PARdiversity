...
my $input_2 = "$input_directory_2"."filtered_"."$window_type"."_"."$window_size"."_"."$pop"."_females_low_diversity.txt";
...
my $output_file = "$output_dir"."filtered_pi."."$pop."."$window_size."."$consensus_type"."_low_diversity.txt";
...
while($count < $count_number){
	...
	if ($neutral_sites > 0) {
		...
		my $input_file = "$input_dir"."filtered_$pop"."_p_sites."."$count"."_low_diversity.txt";
