...
my $output_file_All = "$output_directory"."split_filtered_pi_"."All26_minus_amp.txt";
...
#my (@info_All_nonPAR_noXTR, $info_All_nonPAR_noXTR, $major_All_nonPAR_noXTR, $minor_All_nonPAR_noXTR, $snps_All_nonPAR_noXTR, $sampleSize_All_nonPAR_noXTR);
#my (@info_Afr_nonPAR_noXTR, $info_Afr_nonPAR_noXTR, $major_Afr_nonPAR_noXTR, $minor_Afr_nonPAR_noXTR, $snps_Afr_nonPAR_noXTR, $sampleSize_Afr_nonPAR_noXTR);
#my (@info_Eur_nonPAR_noXTR, $info_Eur_nonPAR_noXTR, $major_Eur_nonPAR_noXTR, $minor_Eur_nonPAR_noXTR, $snps_Eur_nonPAR_noXTR, $sampleSize_Eur_nonPAR_noXTR);

my $n_eur = "10"; my $n_afr = "18"; my $n_all = "52";

#my $neutral_sites_Eur_PAR1 = "736601";
#my $neutral_sites_Eur_PAR2 = "87281";
#my $neutral_sites_Eur_nonPAR = "56091253";
#my $neutral_sites_Eur_XTR = "1489092";
#my $neutral_sites_Eur_nonPAR_noXTR = "54602161";
...
#my $neutral_sites_Afr_nonPAR_noXTR = "53961855";

#my $neutral_sites_All_PAR1 = "679353";
#my $neutral_sites_All_PAR2 = "26629";
my $neutral_sites_All_nonPAR = "53149488";
#my $neutral_sites_All_XTR = "1383357";
#my $neutral_sites_All_nonPAR_noXTR = "30699783";

#my $p_panTro4_PAR1 = "0.0226430335853"; 
#my $p_panTro4_PAR2 = "0.00872039501213";
#my $p_panTro4_nonPAR = "0.00981373935421"; 
#my $p_panTro4_XTR = "0.010937034795"; 
#my $p_panTro4_nonPAR_noXTR = "0.0097822945853819";
...
#my $p_RheMac3_nonPAR_noXTR = "0.0495116968678175";
...
#my $pi_Eur_nonPAR_noXTR = 0;
#my $part_Eur_nonPAR_noXTR = 0;
#my $sum_Eur_nonPAR_noXTR = 0;
...
#my $pi_Afr_nonPAR_noXTR = 0;
#my $part_Afr_nonPAR_noXTR = 0;
#my $sum_Afr_nonPAR_noXTR = 0;
...
#my $pi_All_nonPAR_noXTR = 0;
#my $part_All_nonPAR_noXTR = 0;
#my $sum_All_nonPAR_noXTR = 0;
...
#my $input_file_Eur_nonPAR_noXTR = "/Users/wilsonsayres_lab_admin/Projects/PAR/BrotmanCotter/PAR_Project/Codes_04/05_pi/02_allele_frequency/filtered_split_make_frequency_table/"."5Eur_nonPAR_noXTR_p_sites.txt";
...
#my $input_file_Afr_nonPAR_noXTR = "/Users/wilsonsayres_lab_admin/Projects/PAR/BrotmanCotter/PAR_Project/Codes_04/05_pi/02_allele_frequency/filtered_split_make_frequency_table/"."9Afr_nonPAR_noXTR_p_sites.txt";
...
my $input_file_All_nonPAR = "/Users/wilsonsayres_lab_admin/Projects/PAR/BrotmanCotter/PAR_Project/Codes_04/05_pi/02_allele_frequency/filtered_split_make_frequency_table/"."All26_nonPAR_p_sites_minus_amp.txt";
...
#my $input_file_All_nonPAR_noXTR = "/Users/wilsonsayres_lab_admin/Projects/PAR/BrotmanCotter/PAR_Project/Codes_04/05_pi/02_allele_frequency/filtered_split_make_frequency_table/"."All26_nonPAR_noXTR_p_sites.txt";
...
#open (CG_EUR_nonPAR_noXTR, "<$input_file_Eur_nonPAR_noXTR") or die "Cannot open 1Eu\n";
...
#open (CG_AFR_nonPAR_noXTR, "<$input_file_Afr_nonPAR_noXTR") or die "Cannot open 1Af\n";
...
#open (CG_ALL_nonPAR_noXTR, "<$input_file_All_nonPAR_noXTR") or die "Cannot open All\n";
...
# $pi_All_PAR1 = 2*($sum_All_PAR1*$sampleSize_all)/($neutral_sites_All_PAR1);
# #$pi_All_PAR1 = 2*($sum_All_PAR1*$sampleSize_all)/($neutral_sites_All_PAR1 * $p_RheMac2_PAR1);
...
# $pi_All_PAR2 = 2*($sum_All_PAR2*$sampleSize_all)/($neutral_sites_All_PAR2);
# #$pi_All_PAR2 = 2*($sum_All_PAR2*$sampleSize_all)/($neutral_sites_All_PAR2 * $p_RheMac2_PAR2);
...
my $sampleSize_all = $n_all/($n_all -1);
$pi_All_nonPAR = 2*($sum_All_nonPAR*$sampleSize_all)/($neutral_sites_All_nonPAR);
#$pi_All_nonPAR = 2*($sum_All_nonPAR*$sampleSize_all)/($neutral_sites_All_nonPAR * $p_RheMac2_nonPAR);
...
# 	
# $sampleSize_all = $n_all/($n_all -1); 
# $pi_All_XTR = 2*($sum_All_XTR*$sampleSize_all)/($neutral_sites_All_XTR);  
# #$pi_All_XTR = 2*($sum_All_XTR*$sampleSize_all)/($neutral_sites_All_XTR * $p_RheMac2_XTR);  
...
# 
# 
# while (my $cg_All_nonPAR_noXTR = <CG_ALL_nonPAR_noXTR>){
# 		
# 	if ($cg_All_nonPAR_noXTR =~ /sites/){ 
# 		next;
# 	}
# 	else{
# 		chomp($cg_All_nonPAR_noXTR);	
# 		@info_All_nonPAR_noXTR =  split( '\s' , $cg_All_nonPAR_noXTR); 
# 		
# 		$major_All_nonPAR_noXTR = 1 - $info_All_nonPAR_noXTR[0];
# 		$minor_All_nonPAR_noXTR = $info_All_nonPAR_noXTR[0];
# 		$snps_All_nonPAR_noXTR = $info_All_nonPAR_noXTR[1];
# 		
# 		$part_All_nonPAR_noXTR = $major_All_nonPAR_noXTR*$minor_All_nonPAR_noXTR*$snps_All_nonPAR_noXTR;
# 		
# 		$sum_All_nonPAR_noXTR = $sum_All_nonPAR_noXTR + $part_All_nonPAR_noXTR;
# 	}
# }
# 	
# $sampleSize_all = $n_all/($n_all -1); 
# $pi_All_nonPAR_noXTR = 2*($sum_All_nonPAR_noXTR*$sampleSize_all)/($neutral_sites_All_nonPAR_noXTR);  
# #$pi_All_nonPAR_noXTR = 2*($sum_All_nonPAR_noXTR*$sampleSize_all)/($neutral_sites_All_nonPAR_noXTR * $p_RheMac2_nonPAR_noXTR);  
# $pi_All_nonPAR_noXTR = sprintf("%.8f", $pi_All_nonPAR_noXTR);		
# 
# print OUT_All "nonPAR_noXTR\t$pi_All_nonPAR_noXTR\n"; 
# close(CG_ALL_nonPAR_noXTR);
#--------------------------------------------------------------
#--------------------------------------------------------------
...
#$pi_Afr_PAR1 = 2*($sum_Afr_PAR1*$sampleSize_afr)/($neutral_sites_Afr_PAR1 * $p_panTro3_PAR1);
#$pi_Afr_PAR1 = 2*($sum_Afr_PAR1*$sampleSize_afr)/($neutral_sites_Afr_PAR1 * $p_RheMac2_PAR1);
...
#$pi_Afr_PAR2 = 2*($sum_Afr_PAR2*$sampleSize_afr)/($neutral_sites_Afr_PAR2 * $p_panTro3_PAR2);
#$pi_Afr_PAR2 = 2*($sum_Afr_PAR2*$sampleSize_afr)/($neutral_sites_Afr_PAR2 * $p_RheMac2_PAR2);
...
#	
#$sampleSize_afr = $n_afr/($n_afr -1);
#$pi_Afr_nonPAR = 2*($sum_Afr_nonPAR*$sampleSize_afr)/($neutral_sites_Afr_nonPAR * $p_panTro3_nonPAR);
#$pi_Afr_nonPAR = 2*($sum_Afr_nonPAR*$sampleSize_afr)/($neutral_sites_Afr_nonPAR * $p_RheMac2_nonPAR);
...
#	
#$sampleSize_afr = $n_afr/($n_afr -1); 
#$pi_Afr_XTR = 2*($sum_Afr_XTR*$sampleSize_afr)/($neutral_sites_Afr_XTR * $p_panTro3_XTR); 
#$pi_Afr_XTR = 2*($sum_Afr_XTR*$sampleSize_afr)/($neutral_sites_Afr_XTR * $p_RheMac2_XTR);  
...
#while (my $cg_Afr_nonPAR_noXTR = <CG_AFR_nonPAR_noXTR>){
#		
#	if ($cg_Afr_nonPAR_noXTR =~ /sites/){ 
#		next;
#	}
#	else{
#		chomp($cg_Afr_nonPAR_noXTR);	
#		@info =  split( '\s' , $cg_Afr_nonPAR_noXTR); 
#		
#		$major_Afr_nonPAR_noXTR = 1 - $info_Afr_nonPAR_noXTR[0];
#		$minor_Afr_nonPAR_noXTR = $info_Afr_nonPAR_noXTR[0];
#		$snps_Afr_nonPAR_noXTR = $info_Afr_nonPAR_noXTR[1];
#		
#		$part_Afr_nonPAR_noXTR = $major_Afr_nonPAR_noXTR*$minor_Afr_nonPAR_noXTR*$snps_Afr_nonPAR_noXTR;
#		
#		$sum_Afr_nonPAR_noXTR = $sum_Afr_nonPAR_noXTR + $part_Afr_nonPAR_noXTR;
#	}
#}
#	
#$sampleSize_afr = $n_afr/($n_afr -1); 
#$pi_Afr_nonPAR_noXTR = 2*($sum_Afr_nonPAR_noXTR*$sampleSize_afr)/($neutral_sites_Afr_nonPAR_noXTR * $p_panTro3_nonPAR_noXTR); 
#$pi_Afr_nonPAR_noXTR = 2*($sum_Afr_nonPAR_noXTR*$sampleSize_afr)/($neutral_sites_Afr_nonPAR_noXTR * $p_RheMac2_nonPAR_noXTR);  
#$pi_Afr_nonPAR_noXTR = sprintf("%.8f", $pi_Afr_nonPAR_noXTR);		
#
#print OUT_Afr "$nonPAR_noXTR\t$pi_Afr_nonPAR_noXTR\n"; 
#close(CG_AFR_nonPAR_noXTR);
#--------------------------------------------------------------
#--------------------------------------------------------------
...
#$pi_Eur_PAR1 = 2*($sum_Eur_PAR1*$sampleSize_eur)/($neutral_sites_Eur_PAR1 * $p_panTro3_PAR1);
#$pi_Eur_PAR1 = 2*($sum_Eur_PAR1*$sampleSize_eur)/($neutral_sites_Eur_PAR1 * $p_RheMac2_PAR1);
...
#$pi_Eur_PAR2 = 2*($sum_Eur_PAR2*$sampleSize_eur)/($neutral_sites_Eur_PAR2 * $p_panTro3_PAR2);
#$pi_Eur_PAR2 = 2*($sum_Eur_PAR2*$sampleSize_eur)/($neutral_sites_Eur_PAR2 * $p_RheMac2_PAR2);
...
#	
#$sampleSize_eur = $n_eur/($n_eur -1);
#$pi_Eur_nonPAR = 2*($sum_Eur_nonPAR*$sampleSize_eur)/($neutral_sites_Eur_nonPAR * $p_panTro3_nonPAR);
#$pi_Eur_nonPAR = 2*($sum_Eur_nonPAR*$sampleSize_eur)/($neutral_sites_Eur_nonPAR * $p_RheMac2_nonPAR);
...
#	
#$sampleSize_eur = $n_eur/($n_eur -1); 
#$pi_Eur_XTR = 2*($sum_Eur_XTR*$sampleSize_eur)/($neutral_sites_Eur_XTR * $p_panTro3_XTR);  
#$pi_Eur_XTR = 2*($sum_Eur_XTR*$sampleSize_eur)/($neutral_sites_Eur_XTR * $p_RheMac2_XTR);
...
#while (my $cg_EUR_nonPAR_noXTR = <CG_EUR_nonPAR_noXTR>){
#		
#	if ($cg_EUR_nonPAR_noXTR =~ /sites/){ 
#		next;
#	}
#	else{
#		chomp($cg_EUR_nonPAR_noXTR);	
#		@info =  split( '\s' , $cg_EUR_nonPAR_noXTR); 
#		
#		$major_Eur_nonPAR_noXTR = 1 - $info_Eur_nonPAR_noXTR[0];
#		$minor_Eur_nonPAR_noXTR = $info_Eur_nonPAR_noXTR[0];
#		$snps_Eur_nonPAR_noXTR = $info_Eur_nonPAR_noXTR[1];
#		
#		$part_Eur_nonPAR_noXTR = $major_Eur_nonPAR_noXTR*$minor_Eur_nonPAR_noXTR*$snps_Eur_nonPAR_noXTR;
#		
#		$sum_Eur_nonPAR_noXTR = $sum_Eur_nonPAR_noXTR + $part_Eur_nonPAR_noXTR;
#	}
#}
#	
#$sampleSize_eur = $n_eur/($n_eur -1); 
#$pi_Eur_nonPAR_noXTR = 2*($sum_Eur_nonPAR_noXTR*$sampleSize_eur)/($neutral_sites_Eur_nonPAR_noXTR * $p_panTro3_nonPAR_noXTR);  
#$pi_Eur_nonPAR_noXTR = 2*($sum_Eur_nonPAR_noXTR*$sampleSize_eur)/($neutral_sites_Eur_nonPAR_noXTR * $p_RheMac2_nonPAR_noXTR);
#$pi_Eur_nonPAR_noXTR = sprintf("%.8f", $pi_Eur_nonPAR_noXTR);		
#
#print OUT_Eur "$nonPAR_noXTR\t$pi_Eur_nonPAR_noXTR\n"; 
#close (CG_Eur_nonPAR_noXTR);