...
my $output_file_All = "$output_directory"."split_filtered_pi_"."All26_minus_low.txt";
...
my $input_file_All_nonPAR = "/Users/wilsonsayres_lab_admin/Projects/PAR/BrotmanCotter/PAR_Project/Codes_04/05_pi/02_allele_frequency/filtered_split_make_frequency_table/"."All26_nonPAR_p_sites_minus_low.txt";
