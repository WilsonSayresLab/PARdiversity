...
my $usage = "normalize filtered values of pi by per window divergence between humans and chimps, between humans and macaques, or between humans and dogs";
...
#my $genome = "canFam3"; # Dog
my $genome = "mm10"; # Mouse
