...
#my $output_file_Eur = "$output_directory"."pi_"."5Eur".".RheMac3.noXTR.txt";
#my $output_file_Afr = "$output_directory"."pi_"."9Afr".".RheMac3.noXTR.txt";
#my $output_file_All = "$output_directory"."pi_"."All26".".RheMac3.noXTR.txt";

#_________panTro4

#my $output_file_Eur = "$output_directory"."pi_"."5Eur".".panTro4.noXTR.txt";
#my $output_file_Afr = "$output_directory"."pi_"."9Afr".".panTro4.noXTR.txt";
#my $output_file_All = "$output_directory"."pi_"."All26".".panTro4.noXTR.txt";

#_________canFam3

#my $output_file_Eur = "$output_directory"."pi_"."5Eur".".canFam3.noXTR.txt";
#my $output_file_Afr = "$output_directory"."pi_"."9Afr".".canFam3.noXTR.txt";
#my $output_file_All = "$output_directory"."pi_"."All26".".canFam3.noXTR.txt";

#_________mm10

#my $output_file_Eur = "$output_directory"."pi_"."5Eur".".mm10.noXTR.txt";
#my $output_file_Afr = "$output_directory"."pi_"."9Afr".".mm10.noXTR.txt";
my $output_file_All = "$output_directory"."pi_"."All26".".mm10.noXTR.txt";
...
$sampleSize_all = $n_all/($n_all -1); 
#$pi_All_nonPAR_noXTR = 2*($sum_All_nonPAR_noXTR*$sampleSize_all)/($neutral_sites_All_nonPAR_noXTR * $p_panTro4_nonPAR_noXTR);  
#$pi_All_nonPAR_noXTR = 2*($sum_All_nonPAR_noXTR*$sampleSize_all)/($neutral_sites_All_nonPAR_noXTR * $p_RheMac3_nonPAR_noXTR); 
#$pi_All_nonPAR_noXTR = 2*($sum_All_nonPAR_noXTR*$sampleSize_all)/($neutral_sites_All_nonPAR_noXTR * $p_canFam3_nonPAR_noXTR);
$pi_All_nonPAR_noXTR = 2*($sum_All_nonPAR_noXTR*$sampleSize_all)/($neutral_sites_All_nonPAR_noXTR * $p_mm10_nonPAR_noXTR);  
...
#	
#$sampleSize_afr = $n_afr/($n_afr -1); 
#$pi_Afr_nonPAR_noXTR = 2*($sum_Afr_nonPAR_noXTR*$sampleSize_afr)/($neutral_sites_Afr_nonPAR_noXTR * $p_panTro4_nonPAR_noXTR); 
#$pi_Afr_nonPAR_noXTR = 2*($sum_Afr_nonPAR_noXTR*$sampleSize_afr)/($neutral_sites_Afr_nonPAR_noXTR * $p_RheMac3_nonPAR_noXTR);  
...
#	
#$sampleSize_eur = $n_eur/($n_eur -1); 
#$pi_Eur_nonPAR_noXTR = 2*($sum_Eur_nonPAR_noXTR*$sampleSize_eur)/($neutral_sites_Eur_nonPAR_noXTR * $p_panTro4_nonPAR_noXTR);  
#$pi_Eur_nonPAR_noXTR = 2*($sum_Eur_nonPAR_noXTR*$sampleSize_eur)/($neutral_sites_Eur_nonPAR_noXTR * $p_RheMac3_nonPAR_noXTR);
