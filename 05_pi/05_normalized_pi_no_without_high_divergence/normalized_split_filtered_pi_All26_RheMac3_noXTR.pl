...
#open (CG_EUR_nonPARnoXTR, "<$input_file_Eur_nonPARnoXTR") or die "Cannot open 1Eu\n";
...
#open (CG_AFR_nonPARnoXTR, "<$input_file_Afr_nonPARnoXTR") or die "Cannot open 1Af\n";
...
print OUT_All "nonPARnoXTR\t$pi_All_nonPAR_noXTR\n"; 
