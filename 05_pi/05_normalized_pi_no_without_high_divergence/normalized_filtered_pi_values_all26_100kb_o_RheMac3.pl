...
my $divergence_file = "/Users/wilsonsayres_lab_admin/Projects/PAR/BrotmanCotter/PAR_Project/Codes_04/02_galaxy_chrX_data/filtered_subs_rates_"."$window_size"."_"."$consensus_type"."_"."$genome"."_no_without_high_divergence".".txt";
open ( DIVERGENCE, "<$divergence_file") or die "can't open $divergence_file\n"; 
my @divergence_info = <DIVERGENCE>; 

my $output_file = "/Users/wilsonsayres_lab_admin/Projects/PAR/BrotmanCotter/PAR_Project/Codes_04/05_pi/05_normalized_pi_no_without_high_divergence/normalized_filtered_pi/"."$window_type"."/"."$window_size"."/"."$pop."."$window_size."."$consensus_type".".$genome".".txt";
