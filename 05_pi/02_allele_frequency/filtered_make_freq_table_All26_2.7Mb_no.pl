...
#-------------------------------------------------------------------------------
# What: This program will compute the minor allele frequency in 26 females from 1MB nonoverlapping window minor allele computations. 
#		
#-------------------------------------------------------------------------------

my $usage = "make_freq_table_all26_2.7Mb_no.pl";

#-------------------------------------------------------------------------------

my $count_number = 57; #2.7Mb non overlapping

my $window_size = "2.7Mb_filtered";

my $window_type = "nonoverlapping";

my $pop = "All26";

my $input_dir = "/Users/wilsonsayres_lab_admin/Projects/PAR/BrotmanCotter/PAR_Project/Codes_04/05_pi/01_minor_alleles/filtered_compute_minor_alleles/"."$window_type/"."$window_size/";
my $output_dir = "/Users/wilsonsayres_lab_admin/Projects/PAR/BrotmanCotter/PAR_Project/Codes_04/05_pi/02_allele_frequency/filtered_make_frequency_table/"."$window_type"."/"."$window_size"."/";
...
while($count < $count_number){
	...
	my $output_file = "$output_dir"."filtered_$pop"."_p_sites."."$count".".txt";
	...
	my $input_file = "$input_dir"."filtered_$pop"."_minor_alleles."."$count".".txt";
