...
my $usage = "filtered_split_make_freq_tables_All26_low8.pl";
...
#my $output_low1 = "$output_dir"."$population"."_low1_p_sites".".txt";
#my $output_low2 = "$output_dir"."$population"."_low2_p_sites".".txt";
#my $output_low3 = "$output_dir"."$population"."_low3_p_sites".".txt";
#my $output_low4 = "$output_dir"."$population"."_low4_p_sites".".txt";
#my $output_low5 = "$output_dir"."$population"."_low5_p_sites".".txt";
#my $output_low6 = "$output_dir"."$population"."_low6_p_sites".".txt";
#my $output_low7 = "$output_dir"."$population"."_low7_p_sites".".txt";
my $output_low8 = "$output_dir"."$population"."_low8_p_sites".".txt";

#open(OUT, ">$output_low1");
#open(OUT, ">$output_low2");
#open(OUT, ">$output_low3");
#open(OUT, ">$output_low4");
#open(OUT, ">$output_low5");
#open(OUT, ">$output_low6");
#open(OUT, ">$output_low7");
open(OUT, ">$output_low8");

#my $input_low1 = "$input_dir"."$population"."_low1_minor_alleles.txt";
#my $input_low2 = "$input_dir"."$population"."_low2_minor_alleles.txt";
#my $input_low3 = "$input_dir"."$population"."_low3_minor_alleles.txt";
#my $input_low4 = "$input_dir"."$population"."_low4_minor_alleles.txt";
#my $input_low5 = "$input_dir"."$population"."_low5_minor_alleles.txt";
#my $input_low6 = "$input_dir"."$population"."_low6_minor_alleles.txt";
#my $input_low7 = "$input_dir"."$population"."_low7_minor_alleles.txt";
my $input_low8 = "$input_dir"."$population"."_low8_minor_alleles.txt";

#open (low1, "<$input_low1") or die "Cannot open low1\n";
#open (low2, "<$input_low2") or die "Cannot open low2\n";
#open (low3, "<$input_low3") or die "Cannot open low3\n";
#open (low4, "<$input_low4") or die "Cannot open low4\n";
#open (low5, "<$input_low5") or die "Cannot open low5\n";
#open (low6, "<$input_low6") or die "Cannot open low6\n";
#open (low7, "<$input_low7") or die "Cannot open low7\n";
open (low8, "<$input_low8") or die "Cannot open low8\n";
...
while (my $low8 = <low8>){
	...
	chomp($low8);	#get rid of newline character
	@info =  split('\s', $low8);
