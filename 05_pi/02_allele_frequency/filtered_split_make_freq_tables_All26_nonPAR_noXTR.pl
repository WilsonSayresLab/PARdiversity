...
my $usage = "filtered_split_make_freq_tables_All26_nonPAR_noXTR.pl";
...
#my $output_PAR1 = "$output_dir"."$population"."_PAR1_p_sites".".txt";
#my $output_PAR2 = "$output_dir"."$population"."_PAR2_p_sites".".txt";
my $output_nonPARnoXTR = "$output_dir"."$population"."_nonPAR_noXTR_p_sites".".txt";
#my $output_XTR = "$output_dir"."$population"."_XTR_p_sites".".txt";

#open(OUT, ">$output_PAR1");
#open(OUT, ">$output_PAR2");
open(OUT, ">$output_nonPARnoXTR");
#open(OUT_XTR, ">$output_XTR");

#my $input_PAR1 = "$input_dir"."$population"."_PAR1_minor_alleles.txt";
#my $input_PAR2 = "$input_dir"."$population"."_PAR2_minor_alleles.txt";
#my $input_nonPAR = "$input_dir"."$population"."_nonPAR_minor_alleles.txt";
#my $input_XTR = "$input_dir"."$population"."_XTR_minor_alleles.txt";
my $input_nonPARnoXTR = "$input_dir"."$population"."_nonPAR_noXTR_minor_alleles.txt";

#open (PAR1, "<$input_PAR1") or die "Cannot open PAR1\n";
#open (PAR2, "<$input_PAR2") or die "Cannot open PAR2\n";
#open (nonPAR, "<$input_nonPAR") or die "Cannot open nonPAR\n";
#open (XTR, "<$input_XTR") or die "Cannot open XTR\n";
open (nonPARnoXTR, "<$input_nonPARnoXTR") or die "Cannot open nonPARnoXTR\n";
...
#	}
#
#	chomp($PAR1);	#get rid of newline character
#	@info =  split('\s', $PAR1);
#	
#	$position = $info[0];
#	
...
#	}
#
#	chomp($PAR2);	#get rid of newline character
#	@info =  split('\s', $PAR2);
#	
#	$position = $info[0];
#	
...
while (my $nonPARnoXTR = <nonPARnoXTR>){
	
	if ($nonPARnoXTR =~ /position/){
		next;
	}

	chomp($nonPARnoXTR);	#get rid of newline character
	@info =  split('\s', $nonPARnoXTR);
