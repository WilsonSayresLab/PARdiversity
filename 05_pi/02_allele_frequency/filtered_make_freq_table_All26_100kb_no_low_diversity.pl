...
#-------------------------------------------------------------------------------
# What: This program will compute the minor allele frequency in 26 females from 100kb nonoverlapping window minor allele computations. 
#		
#-------------------------------------------------------------------------------

my $usage = "make_freq_table_all26_100kb_no.pl";
...
while($count < $count_number){
	...
	my $output_file = "$output_dir"."filtered_$pop"."_p_sites."."$count"."_low_diversity.txt";
	...
	my $input_file = "$input_dir"."filtered_$pop"."_minor_alleles."."$count"."_low_diversity.txt";
