...
my $output_file = "$output_directory" . "filtered.CGS.All26_minus_low.txt";
...
my $input_interval = "/Users/wilsonsayres_lab_admin/Projects/PAR/BrotmanCotter/PAR_Project/Codes_04/02_galaxy_chrX_data/filtered_chrX_interval_low.txt";
