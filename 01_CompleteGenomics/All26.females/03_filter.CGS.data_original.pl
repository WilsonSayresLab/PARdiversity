...
my $output_file = "$output_directory" . "filtered.CGS.All26_original.txt";
...
my $input_interval = "/Users/wilsonsayres_lab_admin/Projects/PAR/BrotmanCotter/PAR_Project/Codes_04/02_galaxy_chrX_data/filtered_chrX_interval_original.txt";
