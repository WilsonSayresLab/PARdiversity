...
my $output_file = "$output_directory" . "filtered.CGS.All26_amp.txt";
...
my $input_interval = "/Users/wilsonsayres_lab_admin/Projects/PAR/BrotmanCotter/PAR_Project/Codes_04/02_galaxy_chrX_data/ampliconic_regions.txt";
